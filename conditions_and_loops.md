# 2. Условные конструкции и циклы в Kotlin
...
Как работает конструкция <code>if else</code>? 
...
Цикл <code>for</code> является своеобразной оберткой над <code>while<code> и существует для упрощения.
